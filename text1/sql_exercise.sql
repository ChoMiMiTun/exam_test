...
CREATE TABLE `bonus` (
  `id` int(11) NOT NULL,
  `bonusamount` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `bonusdate` varchar(225) COLLATE utf8_unicode_ci NOT NULL DEFAULT current_timestamp(),
